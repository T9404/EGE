...
for _ in range(n-1): #n-1 ОБЯЗАТЕЛЬНО!
    ...
    cmb = [a+b for a in new_list for b in dinamic_list] #всевозможная генерация
    ...
    new_list = [number_new for number_new in comparison if number_new != float('-inf')] #если значения не пустые
    #print(new_list)
    #input()
