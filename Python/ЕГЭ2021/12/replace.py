...
for i in range(81, 85+1):
    ...
    while '01' in let or '02' in let or '03' in let:
        let = let.replace('01', '33120', 1)
        let = let.replace('02', '3120', 1)
        let = let.replace('03', '20', 1)

    #print(letter, i)
    if let.count('1') == 30 and let.count('2') == 39 and let.count('3') == 42:
        print(i)
        number_1 = i
